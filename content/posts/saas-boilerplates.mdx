...
Jeśli przychodzisz ze świata "wrzuć pliki na FTP", Makerkit wymaga kilku, a nawet kilkudziesięciu godzin nauki, do momentu pierwszego prostego deploymentu na Vercel.
...
Mamy działające środowisko, bazę danych w Dockerze i pierwszą stronę powitalną na `localhost:3000`. Markerkit na start oferuje dobrze zaprojektowane komponenty wykonane z użyciem mojego ulubionego **shadcn/ui**, tworzące podstawową strukturę stron typowego SaaS-a.
